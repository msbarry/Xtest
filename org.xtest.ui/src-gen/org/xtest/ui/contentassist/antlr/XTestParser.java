...
* generated by Xtext
*/
package org.xtest.ui.contentassist.antlr;
...
public class XTestParser extends AbstractContentAssistParser {
	...
	@Override
	protected org.xtest.ui.contentassist.antlr.internal.InternalXTestParser createParser() {
		org.xtest.ui.contentassist.antlr.internal.InternalXTestParser result = new org.xtest.ui.contentassist.antlr.internal.InternalXTestParser(null);
		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getFileParamAccess().getGroup(), "rule__FileParam__Group__0");
					...
					put(grammarAccess.getXAssertExpressionAccess().getGroup_4(), "rule__XAssertExpression__Group_4__0");
					...
					put(grammarAccess.getBodyAccess().getFileparamAssignment_1_0(), "rule__Body__FileparamAssignment_1_0");
					...
					put(grammarAccess.getXAssertExpressionAccess().getActualAssignment_3(), "rule__XAssertExpression__ActualAssignment_3");
					put(grammarAccess.getXAssertExpressionAccess().getThrowsAssignment_4_1(), "rule__XAssertExpression__ThrowsAssignment_4_1");
					...
					put(grammarAccess.getXFeatureCallAccess().getFeatureAssignment_3_0(), "rule__XFeatureCall__FeatureAssignment_3_0");
	...
	protected Collection<FollowElement> getFollowElements(AbstractInternalContentAssistParser parser) {
		try {
			org.xtest.ui.contentassist.antlr.internal.InternalXTestParser typedParser = (org.xtest.ui.contentassist.antlr.internal.InternalXTestParser) parser;
			typedParser.entryRuleBody();
