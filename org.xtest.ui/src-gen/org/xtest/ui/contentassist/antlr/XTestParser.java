		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getJvmVarArgTypeReferenceAccess().getGroup(), "rule__JvmVarArgTypeReference__Group__0");
					put(grammarAccess.getJvmVarArgTypeReferenceAccess().getGroup_1(), "rule__JvmVarArgTypeReference__Group_1__0");
					put(grammarAccess.getJvmVarArgTypeReferenceAccess().getGroup_1_0(), "rule__JvmVarArgTypeReference__Group_1_0__0");
