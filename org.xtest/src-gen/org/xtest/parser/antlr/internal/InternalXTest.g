...
entryRuleFileParam returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getFileParamRule()); }
	 iv_ruleFileParam=ruleFileParam 
	 { $current=$iv_ruleFileParam.current; } 
	 EOF 
;

// Rule FileParam
ruleFileParam returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
(((
...
entryRuleUniqueName returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getUniqueNameRule()); }
	 iv_ruleUniqueName=ruleUniqueName 
	 { $current=$iv_ruleUniqueName.current; } 
	 EOF 
;

// Rule UniqueName
ruleUniqueName returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
((
...
entryRuleXMethodDef returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getXMethodDefRule()); }
	 iv_ruleXMethodDef=ruleXMethodDef 
	 { $current=$iv_ruleXMethodDef.current; } 
	 EOF 
;

// Rule XMethodDef
ruleXMethodDef returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
((
...
entryRuleStaticEquals returns [String current=null] 
	:
	{ newCompositeNode(grammarAccess.getStaticEqualsRule()); } 
	 iv_ruleStaticEquals=ruleStaticEquals 
	 { $current=$iv_ruleStaticEquals.current.getText(); }  
	 EOF 
;

// Rule StaticEquals
ruleStaticEquals returns [AntlrDatatypeRuleToken current=new AntlrDatatypeRuleToken()] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
